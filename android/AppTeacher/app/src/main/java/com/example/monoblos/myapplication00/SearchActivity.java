...
public class SearchActivity extends AppCompatActivity
    ...
    private void setBtnKey(){
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String pass = "http://203.151.92.187:8080/findCourse";
                try {
                    String param = "keyword=" + URLEncoder.encode(editText.getText().toString());
                    httpPostConnection.execute(pass,param);
                    strJson = httpPostConnection.get();
                    if(strJson==null || strJson.length()==0 || strJson.toString().equals("[]")){
                        Toast.makeText(getApplicationContext(),"not found Subject = " + editText.getText() , Toast.LENGTH_SHORT).show();
                    }
                    else {
    ...
    private void setBtnSearch(){
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SearchActivity.this,SearchFromFacActivity.class));
            }
        });
    }
    ...
    private void createList(){
        ...
        try {
            String param = "";
            httpPostConnection.execute("http://203.151.92.187:8080/findCourse",param);
            strJson = httpPostConnection.get();
            JSONArray parentArray = new JSONArray(strJson);
