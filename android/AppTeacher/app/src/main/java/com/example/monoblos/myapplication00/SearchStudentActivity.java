...
public class SearchStudentActivity extends AppCompatActivity
    ...
    private void setBtnKey(){
        Button btn = (Button)findViewById(R.id.btn_key);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String strJson = null;
                String stdName = null;
                String stdLName = null;
                String stdId = null;
                String pass = "http://203.151.92.187:8080/viewEnrolledStudents";
                try {
                    String param = "courseId=" + URLEncoder.encode(editText.getText().toString());
                    httpPostConnection.execute(pass, param);
                    strJson = httpPostConnection.get();
                    Log.i("SearchStudentActivity", strJson);
                    if (strJson == null || strJson.length() == 0) {
                        Toast.makeText(getApplicationContext(), "not found id = " + editText.getText(), Toast.LENGTH_SHORT).show();
                        ...
                        for (int i = 0; i < parentArray.length(); i++) {
                            ...
                            stdName = finalObject.getString("firstName");
                            stdLName = finalObject.getString("lastName");
                            stdId = finalObject.getString("studentId");
                            subjectList.add(stdId + " : " + stdName + " " + stdLName);
    ...
    private void createList(){
        ...
        listSub = (ListView)findViewById(R.id.listView);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onAttach(Activity activity) {
            ...
            ((SearchStudentActivity) activity).onSectionAttached(
